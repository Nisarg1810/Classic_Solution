  ...
  return (
    <div className="relative w-full bg-white">
      ...
      <section className="py-14 sm:py-20 bg-brand-light px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-5xl flex flex-col gap-14 sm:gap-16">

          {/* Banner Image */}
          <div className="w-full relative aspect-[1377/539] rounded-3xl overflow-hidden border border-brand-border/40 shadow-premium bg-white">
            <Image
          ...
          {/* Section 1: Overview */}
          <div className="flex flex-col gap-5 text-left max-w-4xl mx-auto">
          ...
          <div className="border-t border-brand-border/40 pt-12 sm:pt-14 flex flex-col gap-6">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold font-display text-primary mb-2">
                Why Thermal Inspection is Important
              </h2>
              <p className="text-sm sm:text-base text-brand-text leading-relaxed font-light max-w-4xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-brand-border/30 shadow-premium">
              ...
              <div className="lg:col-span-5 flex flex-col gap-5">
                <div className="relative aspect-[611/348] w-full rounded-2xl overflow-hidden border border-brand-border/30 shadow-md bg-white">
                  <Image
                ...
                <div className="relative aspect-[609/391] w-full rounded-2xl overflow-hidden border border-brand-border/30 shadow-md bg-white">
                  <Image
          ...
          <div className="border-t border-brand-border/40 pt-12 sm:pt-14 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 flex flex-col gap-6">
                <div className="bg-white p-6 sm:p-8 rounded-3xl border border-brand-border/30 shadow-premium">
                  <ul className="flex flex-col gap-3">
                ...
                <div className="bg-white p-4 rounded-3xl border border-brand-border/30 shadow-premium flex flex-col items-center gap-3">
                  ...
                  <p className="text-xs font-semibold text-brand-muted text-center">
              ...
              {/* Right Column: 2 Stacked Images */}
              <div className="lg:col-span-5 flex flex-col gap-5">
                <div className="relative aspect-[554/450] w-full rounded-2xl overflow-hidden border border-brand-border/30 shadow-md bg-white">
                  <Image
                ...
                <div className="relative aspect-[521/347] w-full rounded-2xl overflow-hidden border border-brand-border/30 shadow-md bg-white">
                  <Image
          ...
          {/* CTA & Booking Block */}
          <div className="border-t border-brand-border/40 pt-10 flex flex-col sm:flex-row gap-6 items-center justify-between bg-white p-6 sm:p-8 rounded-3xl border border-brand-border/20 shadow-premium">
