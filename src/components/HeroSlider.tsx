  ...
  return (
    <div className="relative w-full">
      <section
        ...
        style={{ height: "clamp(420px, 80vw, 580px)" }}
      >
        {/* Background Images */}
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 bg-black/70 backdrop-blur-sm text-white border-t border-white/10 py-2.5 md:py-3">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-10">
          ...
          {/* ── DESKTOP layout (≥ md): original full bar ── */}
